...
``find [-P | -L] [--exclude-dir=path] path [expression]``
...
Bug reports and pull requests are welcome on GitHub at https://github.com/[USERNAME]/find-like. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [Contributor Covenant](http://contributor-covenant.org) code of conduct.
